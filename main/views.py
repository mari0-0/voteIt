...
#     otp = Otp.objects.get(email=voter.mail).otp
#     try:
#       int(userEnteredOtp)
#     except:
...
#       user = voter.user
#       if user is not None:
#         return redirect(f'/verifyPassword?cwid={cwid}')
#       else:
...
# def login_password_verify(request):
...
#   return render(request, 'verify1.html',{'active': 'vote', 'cwid': cwid})
